    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mt-2">
          <div className="flex items-center gap-4">
            <img src="/images/logo.jpg" className="h-12 w-auto  shadow-soft" alt="logo" />
            <div>
        ...
        <main className="mt-8 bg-white dark:bg-slate-950 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 p-6 sm:p-8">
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-5" onSubmit={e => { e.preventDefault(); handleNext(); }}>
            <div className="flex flex-col gap-1">
              ...
              <input id="cust-name" value={customer.name || ''} onChange={e=>setCustomer({...customer,name:e.target.value})} className="rounded-xl border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-slate-900/70 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 dark:focus:ring-brand-400 text-gray-900 dark:text-gray-100" placeholder=" " required />
            </div>
            <div className="flex flex-col gap-1">
              <label htmlFor="cust-company" className="text-sm font-medium">Company <span className="text-red-600">*</span></label>
              <input id="cust-company" value={customer.company || ''} onChange={e=>setCustomer({...customer,company:e.target.value})} className="rounded-xl border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-slate-900/70 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 dark:focus:ring-brand-400" placeholder="" required />
            </div>
            <div className="flex flex-col gap-1">
              <label htmlFor="cust-phone" className="text-sm font-medium">Phone <span className="text-red-600">*</span></label>
              <input id="cust-phone" value={customer.phone || ''} onChange={e=>setCustomer({...customer,phone:e.target.value})} className="rounded-xl border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-slate-900/70 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 dark:focus:ring-brand-400" placeholder="" required />
            </div>
            <div className="flex flex-col gap-1">
              <label htmlFor="cust-email" className="text-sm font-medium">Email</label>
              <input id="cust-email" type="email" value={customer.email || ''} onChange={e=>setCustomer({...customer,email:e.target.value})} className="rounded-xl border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-slate-900/70 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 dark:focus:ring-brand-400" placeholder="name@example.com" />
            </div>
            <div className="md:col-span-2 flex flex-col gap-1">
              <label htmlFor="cust-address" className="text-sm font-medium">Address</label>
              <textarea id="cust-address" value={customer.address || ''} onChange={e=>setCustomer({...customer,address:e.target.value})} className="rounded-xl border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-slate-900/70 px-3 py-2 text-sm h-24 focus:outline-none focus:ring-2 focus:ring-brand-500 dark:focus:ring-brand-400 resize-none" placeholder="Full mailing address" />
            </div>
            <div className="flex flex-col gap-1">
              <label htmlFor="cust-city" className="text-sm font-medium">City</label>
              <input id="cust-city" value={customer.city || ''} onChange={e=>setCustomer({...customer,city:e.target.value})} className="rounded-xl border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-slate-900/70 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 dark:focus:ring-brand-400" placeholder="" />
            </div>
            {/* <div className="flex flex-col gap-1">
            ...
            <div className="flex flex-col gap-1">
              ...
              <input id="cust-state" value={customer.state || ''} onChange={e=>setCustomer({...customer,state:e.target.value})} className="rounded-xl border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-slate-900/70 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 dark:focus:ring-brand-400" />
            </div>
          </form>
          <div className="mt-8 flex flex-wrap gap-3">
            <Button onClick={handleNext} variant="primary" size="md">Choose Machine Type</Button>
            <label className="cursor-pointer inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gray-200 dark:bg-slate-900/70 text-gray-800 dark:text-gray-100 text-sm font-medium shadow-soft hover:bg-gray-300 dark:hover:bg-gray-700 transition">
              Import JSON
        ...
        <footer className="mt-44 text-center text-xs text-gray-600 dark:text-gray-400 border-t border-gray-700"><br />
